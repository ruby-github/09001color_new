...
void MeasureMan::SingleMeaDataMan(const float meaData, const SingleItemInfo *itemInfo, float allData[SINGLE_MAX], const int saveR) {
...
void MeasureMan::MultiMeaDataMan(float meaData[MEA_MULTI], const MultiItemInfo *itemInfo, float allData[MULTI_MAX], const int saveR) {
    int i, j;
    CalcInfoTmp calcInfo;
    const CalcInfoArray *multiMethInfo;
