...
void ImageArea::DrawDashArc(DrawAttr &attr, const GdkColor* const color, int x, int y, int width, int height, double angle1, double angle2, bool update) {
    if (width == 0)
        return;

    double a = (double)5 * 360 / PI / width;
    double i = (double)0;
    int xPos = 0, yPos = 0;
