...
#define KEY_BB 0x81
#define KEY_BM 0x82
#define KEY_REVIEW 0x8E //¶ÁÈ¡
#define KEY_ARCHIVE 0xBD   //¿ì´æ
#define KEY_ENDEXAM 0x91 //´æ´¢
//#define KEY_ENDEXAM 0xF9 //´æ´¢
#define KEY_SAVE 0xF9 //´òÓ¡
//#define KEY_SAVE 0x91 //´òÓ¡
...
#define KEY_PAGEUP 0xE7
#define KEY_PAGEDOWM 0xE0
#define KEY_SPACE 0x20 //Ð´Ì½Í·
#define KEY_ONE 0x97 //ÖÐÓ¢ÎÄÇÐ»»
#define KEY_P1 0xD5
#define KEY_P2 0xD6
