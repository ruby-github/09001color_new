...
//	unsigned char upside_max_point, downside_max_point;
    ...
    char hospital[6][100] = {{"Hospital: "},{"医院名称："}, {"Больница: "} ,{"Szpital: "}, {"Hpital: "}, {"Krankenhaus: "}};
...
//hlx
...
#endif
    //char sex[6][50] = {{"Sex: "},{"性别："}, {"Пол: "}, {"Pe:"}, {"Sexe: "}, {"Geschlecht: "}};
    char sex[6][50] = {{"Gender: "},{"性别："}, {"Пол: "}, {"Pe:"}, {"Sexe: "}, {"Geschl: "}};
    ...
    char ul_idea[6][20] = {{"Descriptor: "},{"超声所见："}, {"Описание: "}, {"Opisujcy: "}, {"Descripteur: "}, {"Beschreibung: "}};
