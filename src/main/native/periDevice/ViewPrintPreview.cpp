...
void ViewPrintPreview::CreatePages(char *path) {
    ...
    char idstr[50], namestr[60], check_numstr[50], sexstr[50], agestr[50], ageUnitstr[50],sectionstr[50], check_datestr[50], check_doctorstr[50], report_doctorstr[50], ul_ideastr[2000], commentstr[2000];
    char tmp[1000];
#ifdef VET
    char ownerstr[60];
    char speciesstr[60];
