...
#ifdef EMP_440
enum EProbeList440 {P35CV, P65VMC, P75LVS, PT65C15D}; // P35C20H, P28P16, P90L25K, P10L25J, P35D50D}; //80 ÕóÔª
...
unsigned char ProbeT65C15D[PROBE_INFO_SIZE] = { //65C15D  //¸ßÆµÎ¢Í¹
    // black-white
    '6',	'5',	'C',	'1',	'5',	'G',	'0',	'0',	'0',	'0',
