...
private:
    ...
    // call back
    static void HandleBtnExitClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnExitClicked(button);
    }
    static void HandleBtnEditClicked(GtkButton *button, ViewArchiveImgMan* data) {
    ...
    static void HandleBtnShowClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtniShowClicked(button);
    }
    static void HandleBtnDeleteClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnDeleteClicked(button);
    }
    static void HandleBtnUnselAllClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnUnselAllClicked(button);
    }
    static void HandleBtnSelAllClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnSelAllClicked(button);
    }
    static void HandleBtnLastPatClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnLastPatClicked(button);
    }
    static void HandleBtnNextPatClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnNextPatClicked(button);
    }
    static void HandleBtnLastImgPageClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnLastImgPageClicked(button);
    }
    static void HandleBtnNextImgPageClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnNextImgPageClicked(button);
    }
    static void HandleSnapImgClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnSnapImgClicked(button);
    }
    static void HandleCheckBtnClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->ChkBtnClicked(button);
    }
    static void HandleComboTypeClicked(GtkComboBox *combobox, ViewArchiveImgMan* data) {
        data->ComboTypeClicked(combobox);
    }
    static void HandleBtnReplayClicked(GtkButton *button, ViewArchiveImgMan* data) {
        data->BtnReplayClicked(button);
    }
    static void HandleBtnPrintClicked(GtkButton *button, ViewArchiveImgMan* data) {
    ...
    static void on_auto_radio_button_toggled(GtkToggleButton *togglebutton, ViewArchiveImgMan *data) {
        data->AutoRadioToggled(togglebutton);
    }
    static void on_orignial_radio_button_toggled(GtkToggleButton *togglebutton, ViewArchiveImgMan *data) {
        data->OrignialRadioToggled(togglebutton);
    }
