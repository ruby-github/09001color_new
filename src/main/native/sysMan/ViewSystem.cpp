...
const char *sectionstr[][LANG_MAX] = {
    ...
    {"Small Part", "\u5c0f\u5668\u5b98", "\u0414\u0435\u0442\u043e\u043b\u044c\u043d\u043e", "Ma\u0142e narz\u0105dy", "Petite partie", "Pequeas partes", "Small-Parts",             },  //"Small Part"
    {"Fetal Cardio", "\u80ce\u513f\u5fc3\u810f", "\u041a\u0430\u0440\u0434\u0438\u043e. \u043f\u043b\u043e\u0434\u0430", "Kardio. P\u0142odu","Cardio f\u0153tal",  "Fetal Cardio","ftale Kardio"    },  //"Fetal Cardio"
    {"Vascular", "\u8840\u7ba1", "\u0421\u043e\u0441\u0443\u0434\u044b", "Naczynia","Vasculaire", "Vascular", "Vaskulr",                        },  //"Vascular"
...
#else
    {"TCD", "\u7ecf\u9885\u591a\u666e\u52d2", "TCD", "TCD", "TCD","TCD",  "TCD",                                                                   },  //"TCD"
    {"Orthopedic", "\u77eb\u5f62\u5916\u79d1", "\u041e\u0440\u0442\u043e\u043f\u0435\u0434\u0438\u044f", "Ortopedia",  "Orthopédie",   "Ortopedico", "Orthopdisch",                }   //"Orthopedic"
#endif
};
#else
...
const char *sectionstr[][LANG_MAX] = {
    ...
    {"Urology", "\u6ccc\u5c3f\u79d1", "\u0423\u0440\u043e\u043b\u043e\u0433\u0438\u044f", "Urologia","Urologie", "Urologico", "Urologie",   },  //"Urology"
    {"Obstetrics", "\u4ea7\u79d1", "\u0410\u043a\u0443\u0448\u0435\u0440\u0441\u0442\u0432\u043e", "Po\u0142o\u017cnictwo", "Obstétrique", "Obstetrico",  "Geburtshilfe",     },  //"Obstetrics"
    {"Gynecology", "\u5987\u79d1", "\u0413\u0438\u043d\u0435\u043a\u043e\u043b\u043e\u0433\u0438\u044f", "Ginekologia","Gynécologie", "Gynecologico",  "Gynkologie",        },  //"Gynecology"
    {"Small Part", "\u5c0f\u5668\u5b98", "\u0414\u0435\u0442\u043e\u043b\u044c\u043d\u043e", "Ma\u0142e narz\u0105dy", "Petite partie", "Pequeas partes","Small-Parts",             },  //"Small Part"
    {"Fetal Cardio", "\u80ce\u513f\u5fc3\u810f", "\u041a\u0430\u0440\u0434\u0438\u043e. \u043f\u043b\u043e\u0434\u0430", "Kardio. P\u0142odu","Cardio f\u0153tal", "Cardio Fetal", "ftale Kardio"    },  //"Fetal Cardio"
    {"Others", "其他", "Другие", "Inne", "Autres",  "Otro","Andere",                                                                   },  //"Others"
...
{"Template 1",  "\u6a21\u677f1", "\u0428\u0430\u0431\u043b\u043e\u043d 1", "szablon 1", "Modle 1",  "Templete 1",  "Template 1",     };//"templet"
const char *Customstr[LANG_MAX] = ////{ ENGLISH, CHINESE, RU, PL, ,FR,es, DE}
{"Custom Template", "\u81ea\u5B9a\u4e49\u6a21\u677f", "\u041f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c\u0441\u043a\u0438\u0435 \u0448\u0430\u0431\u043b\u043e\u043d\u044b","Custom Template","Modle auto-dfini", "Custom Templete","Custom Template",      };//"Custom Template"
...
GtkWidget* ViewSystem::create_note_general(void) {
    ...
    gtk_combo_box_append_text (GTK_COMBO_BOX (m_combobox_language), "Franais");
    gtk_combo_box_append_text (GTK_COMBO_BOX (m_combobox_language), "Espaol");
...
// gtk_combo_box_set_active(GTK_COMBO_BOX(m_combobox_probe_type), 0);
    ...
    if ((strcmp(name, "System Default") != 0) && (strcmp(name, "Умолчан системы") != 0) &&
            (strcmp(name, "系统默认") != 0) && (strcmp(name, "Domylne Systemu") != 0)  &&
