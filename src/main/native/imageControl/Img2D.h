...
public:
    ...
    int GetImgStartDots();
    int GetScanLines();
    int GetScanLineIndex() {
        return m_indexScanLines;   ///<index of scan lines
    }
    ...
    int  GetTpViewIndex(void) {
        return m_tpViewIndex;
    }
    ...
    int GetCompoundSpaceIndex(void) {
        return m_spaceCompoundIndexBak;
    }
    bool GetCompoundFreqCtrl(void) {
        return m_freqCompoundCtrlBak;
    } //m_freqCompoundCtrl; }
    ...
    int GetHarmonicFreqIndex() {
        return  (m_harmonicFreqIndex);
    }
    int GetFreqIndex() {
        return m_freqIndex;
    }
